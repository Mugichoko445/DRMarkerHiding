...
namespace dr
{
	namespace det
	{
		struct PixMixParams
		{
			...
			int maxRandSearchItr = 0;	// max number of random sampling per pixel
			...
			int maxPyrmLv = 5;			// maximum pyramid level
		};
		...
		inline cv::Mat1f* OneLvPixMix::GetCostMapPtr()
		{
			return &mCostMap;
		}
